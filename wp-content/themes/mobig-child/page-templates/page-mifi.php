  ...
  <section class="bannerInt bannerIntTel">
    ...
    <section class="Modem-sec">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <img src="<?php echo get_stylesheet_directory_uri(''); ?>/assets/img/mifi/mifi.png" class="Modem-sec__img" alt="mifi" />
          </div>
          <div class="col-sm-6 text-left Modem-sec__cont">
            <h1 class="Modem-sec__title">MIFI ES NUESTRO MODEM INALÁMBRICO</h1>
            <p class="Modem-sec__desc">Su práctico tamaño te permite transportarlo a <br />todos lados las 24 horas del día con cobertura <br/> nacional.</p>
          </div>
        </div><!-- end.row -->
      </div><!-- end.container -->
