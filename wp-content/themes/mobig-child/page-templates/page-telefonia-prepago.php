      ...
      <div class="titleInt">
        <div class="container">
          <div class="row">
            ...
            <p class="bannerIntTel__desc">Una vez realizado el proceso de portabilidad elige uno de los planes ue se adapten mejor a tus necesidades y recarga por medio de nuestra página de internet, app, call center o en más de nuestros 4,000 puntos.</p>
