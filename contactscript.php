...
if(isset($_POST) && !empty($_POST['inpEmail'])){
   ...
   $_POST["inpTel"]  = (isset($_POST["inpTel"]) && !empty($_POST["inpTel"])) ? $_POST["inpTel"] : 0;
   $_POST["mensaje"] = (isset($_POST["mensaje"]) && !empty($_POST["mensaje"])) ? $_POST["mensaje"] : 0;

    $sql = "INSERT INTO dbm0b1g_contacto (nombre, correo, telefono, mensaje) VALUES ('".utf8_decode($_POST['inpNombre'])."', '".utf8_decode($_POST['inpEmail'])."', '".$_POST['inpTel']."', '".utf8_decode($_POST['mensaje'])."')";
    
    $servername = "thefactorysw.net";
    $database = "db_mobig2021";
    $username = "mobig";
    $password = "Azi8914less.ñ";
    // Create connection
      ...
      <tr>
       <td align='middle' align='center' bgcolor='#ffffff' style='height: auto; padding: 10px 15px;width: 100%;'>
          <table width='100%' border='0' cellpadding='5' cellspacing='0'>
            <tr>
              <td align='center' style='display:none;''><img src='https://peibo.concepthaus.dev/wp-content/themes/peibo-child/assets/img/logos/logoHeader.png' width='200' alt='Peibo'/></td>
            </tr>
          </table>
        </td>
      </tr>
       ...
       <td align='middle' bgcolor='#ffffff'style='height: auto; padding: 20px 15px;width: 100%;'>
          <table align='center' width='80%' border='0' cellpadding='5' cellspacing='0'>
            <tr>
             ...
             <tr>
                <td width='50%' style='color:#2E3649;font-weight: bold;font-size: 18px;'>Teléfono:</td>
                <td style='color:#2E3649;font-weight: normal;font-size: 14px;'>".$_POST['inpTel']."</td>
            </tr>
            <tr>
             ...
             <tr>
                ...
                <td style='color:#2E3649;font-weight: normal;font-size: 14px;'>".$_POST['mensaje']."</td>
            </tr>
            </table>
        </td>
      </tr>
          ...
          <table width='100%' border='0' cellpadding='5' cellspacing='0'>
            <tr>
              <td align='center' style='color:#ffffff;font-weight: 300px;font-size: 13px;'>
                ...
                <a href='mailto:info@mobig.mx' target='_blank' style='color:#ffffff;font-weight: 400px;font-size: 13px;'>info@mobig.mx</a> | <a href='https://mobig.mx' target='_blank' style='color:#ffffff;font-weight: 400px;font-size: 13px;'>www.mobig.mx</a>
              </td>
            </tr>
          </table>
        </td>
